...
\noindent 
In this paper, we present the design of YouPower, a social smart grid platform that is designed as a means to explore the potential and challenges of supporting social participation, awareness and engagement of power gird users. The intention of developing such a system is to make energy visible, to inform users' energy know-how, to promote
...
(copied  from the previous year's paper. needs to be updated and rewritten) The idea of linking smart grids with (online) \textit{Social Network}s (SNs) as a joint R\&D topic has recently caught
...
\begin{center}\footnotesize
	\includegraphics[width=.9\textwidth]{img/civis_platform_overview.pdf}\\
